		...
		$params = apply_filters(
			...
			array(
				...
				'params'  => array(
					array(
						'to'   => $lock_address,
						'data' => sprintf( '0x70a08231000000000000000000000000%s', $user_ethereum_address ),
					),
					'latest',
				),
				'id'      => 31337,
...
//		);
	...
	public static function networks_list() {
		$networks = array(
			'ethereum'  => array(
				...
				'network_id'           => 1,
				'network_rpc_endpoint' => 'https://mainnet.infura.io/v3/4ba66d1ed843403d8a3928c47c6d731d',
			),
			'bnbchain'  => array(
				'network_name'         => 'BNB Chain',
				'network_id'           => 56,
				'network_rpc_endpoint' => 'https://bsc-dataseed4.ninicoin.io',
			),
			'polygon'     => array(
			...
			'optimism'     => array(
				...
				'network_id'           => 10,
				'network_rpc_endpoint' => 'https://mainnet.optimism.io',
			),
			'moonbeam'  => array(
				'network_name'         => 'Moonbeam',
				'network_id'           => 1284,
				'network_rpc_endpoint' => 'https://rpc.api.moonbeam.network',
			),
		);
	...
	public static function render_checkout_button( $locks ) {
		...
		$checkout_button_text       = up_get_general_settings( 'checkout_button_text', __( 'Mint', 'unlock-protocol' ) );
	...
	public static function render_login_button() {
		$login_button_text       = up_get_general_settings( 'login_button_text', __( 'Connect Wallet', 'collectify' ) );
